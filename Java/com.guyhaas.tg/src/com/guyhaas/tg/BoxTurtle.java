 ...
 * its image. In this case, the image is a rectangle.
 * <p>
 * @author Guy Haas
 */
public class BoxTurtle extends SpritePixels {
    ...
    * Minimum height and width of a rectangle
    ...
    /**
     * Return a BoxTurtle Sprite with the specified dimensions, color and
     * heading.
     */
    ...
    /**
     * Return the minimum height of this SpriteImage. Subclasses should override
     * this method if they support a different minimum height.
     */
    ...
    /**
     * Return the minimum width of this SpriteImage. Subclasses should override
     * this method if they support a different minimum width.
     *
     */
