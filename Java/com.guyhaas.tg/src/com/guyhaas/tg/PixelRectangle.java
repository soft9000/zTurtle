 ...
 * <p>
 * To represent rectangular groups of pixels as a single entitly, two things are
 * needed:
 * <ul>
...
public class PixelRectangle {
    ...
    /**
     * Array of individual pixels represented as ints, 4 bytes: opacity, red,
     * green, and blue.
     */
    public int[] pixels;
     ...
     * @param numCol the number of columns making up a single row of pixels
     */
    ...
    /**
     * Create an Image to match the array of picture's pixels. AWT Graphics only
     * supports painting of Image objects, no kind of BitBlt for arrays of pixel
     * values (?who know's why?)
     */
    ...
    /**
     * Override Object.toString() for debugging. Return String with
     * PixelRectangle dimensions in square brackets and the first three pixel
     * values enclosed in squiggle brackets, broken down into a,r,g,b
     * components.
     */
