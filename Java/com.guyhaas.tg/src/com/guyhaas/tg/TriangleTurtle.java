...
/**
 * This class provides the turtle's appearance, the array of pixels that make up
 * its image. In this case, the image is an isoseles triangle - the original
 * standard Logo turtle.
 * <p>
 * @author Guy Haas
 */
public class TriangleTurtle extends SpritePixels {
    ...
    * rotated around its center pixel.
    ...
    /**
     * Initialize the turtle's pixels, an isosceles triangle, into the provided
     * int[] turtlePixels. SpritePixels EXPECTS/REQUIRES the image to be on its
     * side, pointing RIGHT/EAST, aligned with the positive X-axis, a heading of
     * mathematical 0 degrees (not to be confused with TurtleSpace's coordinate
     * system where 0 degrees is UP/NORTH, the positive Y-axis).
     */
