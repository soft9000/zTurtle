...
/**
 * A TGPoint is a virtual point, a point in TurtleSpace. In TurtleSpace, 0.0,0.0
 * is at the center of the graphics canvas, like the way coordinate spaces are
 * represented in Algebra. Likewise, TGPoints have appoximated real number
 * coordinates. TGPoints may or may not be visible based upon the current size
 * of the graphics canvas window of TG. Methods are provided to map the point's
 * coordinates from TurtleSpace to an Image's x and y indicies.
 * <p>
 * TurtleGraphics now works entirely with TGPoints - points in TurtleSpace.
 * Early versions of TG used int primitive values for X and Y coordinates. This
 * approach led to too many visual problems caused by the propagation of
 * rounding off values. TGPoint isolates actual implementation of points to one
 * place which can thus be more easily controlled.
 */
public class TGPoint implements Cloneable {
    ...
    /**
     * Constructs a new TGPoint (a virtual point in TurtleSpace) based upon
     * provided double values for x and y coordinates.
     */
    ...
    /**
     * Constructs a new TGPoint (a virtual point in TurtleSpace) based upon
     * provided float values for x and y coordinates.
     */
    ...
    /**
     * Constructs a new TGPoint (a virtual point in TurtleSpace) based upon
     * provided int values for x and y coordinates.
     */
    ...
    /**
     * Constructs a new TGPoint (a virtual point in TurtleSpace) based upon
     * provided long values for x and y coordinates.
     */
    ...
    /**
     * Override Object.equals(Object) so that comparison is based on the x and y
     * fields.
     */
    ...
    public double imageY(double imageHeight) {
        double yCenter = imageHeight / 2.0;
        return yCenter - y;
    }
