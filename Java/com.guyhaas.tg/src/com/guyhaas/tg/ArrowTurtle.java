 ...
 * its image. In this case, the image is an arrow.
 * <p>
 * @author Guy Haas
 */
public class ArrowTurtle extends SpritePixels {
    ...
    * Default height and width of an ArrowTurtle's image
     ...
     *
     * The arrow's geometry has a shaft either half the spriteHeight (for arrows
     * with widths equal-to or greater than their height) or two-thirds the
     * spriteHeight (for arrows whose heights are greater than their widths).
